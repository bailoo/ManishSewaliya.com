...
Contributors: egany, nguyenduyphong88  
...
2. Import Page
3. Display on backend 
4. Display on frontend 
5. Settings General (Premium version on EGANY site http://egany.com )
6. Settings Page/Group (Premium version on EGANY site http://egany.com )
7. Display on frontend (Premium version on EGANY site http://egany.com ) 
8. Display on backend (Premium version on EGANY site http://egany.com ) 

== Changelog ==

= 1.0.3 =
* Update fetching for any types of Facebook posts (message, link, photo... and other types).  

= 1.0.2 =
* Each of fetching-ajax, checking at-least-one imported-posts to do next one. 
* Update "paging" param for next FB-query. 
